...
contract('FiatContract', function(accounts) {
  ...
  it("should insert new ETH price", function() {
    return FiatContract.deployed().then(function(instance) {
      market = instance;
  ...
  it("should request to update price", function() {
	...
	it("should be FiatContract contract address", function() {
	  return Example.deployed().then(function(instance) {
	    return instance.PriceAddress.call()
	  }).then(function(address) {
	    assert.equal(address, priceAddress, "Example has FiatContract contract correct");
	  });
	});
